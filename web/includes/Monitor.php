...
class Monitor extends ZM_Object {
  ...
  // onward therefore sits 4 or 8 bytes later than the naive packed offset.
  // SharedData is 896 bytes and TriggerData starts at 896. The authoritative
  // source is the same alignment computation ZoneMinder::Memory (Memory.pm)
  // performs; a sizeof(SharedData)==896 static_assert in zm_monitor.h guards
  // the layout.
  private $shm_offsets = ['SharedData' => [
    'size'               => [ 'type'=>'uint32', 'offset'=>0, 'size'=>4 ],
    'last_capture_index' => [ 'type'=>'int32', 'offset'=>4, 'size'=>4 ],
    'last_decoder_index' => [ 'type'=>'int32', 'offset'=>8, 'size'=>4 ],
    'last_read_index'    => [ 'type'=>'int32', 'offset'=>12, 'size'=>4 ],
    'last_analysis_index'  => [ 'type'=>'int32', 'offset'=>16, 'size'=>4 ],
    'capture_image_count'  => [ 'type'=>'int32', 'offset'=>20, 'size'=>4 ],
    'decoder_image_count'  => [ 'type'=>'int32', 'offset'=>24, 'size'=>4 ],
    'analysis_image_count' => [ 'type'=>'int32', 'offset'=>28, 'size'=>4 ],
    'state'            => [ 'type'=>'uint32', 'offset'=>32, 'size'=>4 ],
    'capture_fps'      => [ 'type'=>'double', 'offset'=>40, 'size'=>8 ],
    'analysis_fps'     => [ 'type'=>'double', 'offset'=>48, 'size'=>8 ],
    'latitude'         => [ 'type'=>'double', 'offset'=>56, 'size'=>8 ],
    'longitude'        => [ 'type'=>'double', 'offset'=>64, 'size'=>8 ],
    'last_event'       => [ 'type'=>'uint64', 'offset'=>72, 'size'=>8 ],
    'action'           => [ 'type'=>'uint32', 'offset'=>80, 'size'=>4 ],
    'brightness'       => [ 'type'=>'int32', 'offset'=>84, 'size'=>4 ],
    'hue'              => [ 'type'=>'int32', 'offset'=>88, 'size'=>4 ],
    'colour'           => [ 'type'=>'int32', 'offset'=>92, 'size'=>4 ],
    'contrast'         => [ 'type'=>'int32', 'offset'=>96, 'size'=>4 ],
    'alarm_x'          => [ 'type'=>'int32', 'offset'=>100, 'size'=>4 ],
    'alarm_y'          => [ 'type'=>'int32', 'offset'=>104, 'size'=>4 ],
    'valid'            => [ 'type'=>'uint8', 'offset'=>108, 'size'=>1 ],
    'capturing'        => [ 'type'=>'uint8', 'offset'=>109, 'size'=>1 ],
    'analysing'        => [ 'type'=>'uint8', 'offset'=>110, 'size'=>1 ],
    'recording'        => [ 'type'=>'uint8', 'offset'=>111, 'size'=>1 ],
    'signal'           => [ 'type'=>'uint8', 'offset'=>112, 'size'=>1 ],
    'format'           => [ 'type'=>'uint8', 'offset'=>113, 'size'=>1 ],
    'audio_level'      => [ 'type'=>'uint8', 'offset'=>114, 'size'=>1 ],
    'audio_alarm'      => [ 'type'=>'uint8', 'offset'=>115, 'size'=>1 ],
    'camera_width'     => [ 'type'=>'uint32', 'offset'=>116, 'size'=>4 ],
    'camera_height'    => [ 'type'=>'uint32', 'offset'=>120, 'size'=>4 ],
    'imagesize'        => [ 'type'=>'uint32', 'offset'=>124, 'size'=>4 ],
    'last_frame_score' => [ 'type'=>'uint32', 'offset'=>128, 'size'=>4 ],
    'audio_frequency'  => [ 'type'=>'uint32', 'offset'=>132, 'size'=>4 ],
    'audio_channels'   => [ 'type'=>'uint32', 'offset'=>136, 'size'=>4 ],
    'startup_time'     => [ 'type'=>'time_t64', 'offset'=>144, 'size'=>8 ],
    'heartbeat_time'   => [ 'type'=>'time_t64', 'offset'=>152, 'size'=>8 ],
    'last_write_time'  => [ 'type'=>'time_t64', 'offset'=>160, 'size'=>8 ],
    'last_read_time'   => [ 'type'=>'time_t64', 'offset'=>168, 'size'=>8 ],
    'last_viewed_time' => [ 'type'=>'time_t64', 'offset'=>176, 'size'=>8 ],
